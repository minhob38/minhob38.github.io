...
epsg(European Petroleum Survey Group) 좌표계를 관리하는 기관
4326

_.shp: geometry 정보(점, 선, 다각형)
_.dbf: 각 geometry에 대한 속성정보 저장
_.shx: geometry와 속성(attributes) 정보 연결
_.prj: 좌표계 정보 저장
